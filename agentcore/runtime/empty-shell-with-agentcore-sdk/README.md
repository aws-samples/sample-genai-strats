# AgentCore Runtime - Empty Shell with AgentCore SDK

A minimal [Amazon Bedrock AgentCore Runtime](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/agents-tools-runtime.html) that echoes back the received payload. Uses the `bedrock-agentcore` Python SDK to implement the AgentCore runtime interface.
...
├── src/
│   └── agent/
│       ├── main.py         # AgentCore runtime entrypoint (bedrock-agentcore SDK)
